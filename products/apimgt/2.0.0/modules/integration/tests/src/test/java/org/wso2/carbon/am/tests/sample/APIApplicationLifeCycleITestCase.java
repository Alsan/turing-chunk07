...
public class APIApplicationLifeCycleITestCase extends APIManagerIntegrationTest {
    ...
    public void testAPIApplicationLifeCycleITestCase() throws Exception {
        ...
        AddAPIRequest apiRequest = new AddAPIRequest(APIName, APIContext, new URL(url));
        ...
        UpdateAPILifeCycleStateRequest updateRequest = new UpdateAPILifeCycleStateRequest(APIName, providerName, APILifeCycleState.PUBLISHED);
        ...
        AddAPISubscriptionRequest subscriptionRequest = new AddAPISubscriptionRequest(APIName, userInfo.getUserName());
      ...
      //  for (int i = 0; i < 19; i++) {
          ...
          //  System.out.println("==================================================================================" + i + "==========" + youTubeResponse.getResponseCode());
       ...
       //Thread.sleep(60000);
        ...
        //TODO need to reformat this code after we finalize new jaggery APIS
        ...
        AddAPISubscriptionRequest subscriptionRequest1 = new AddAPISubscriptionRequest(APIName, userInfo.getUserName());
        ...
        HttpResponse youTubeResponse2 = HttpRequestUtil.doGet(getApiInvocationURLHttp("testAPI/1.0.0/most_popular"), requestHeaders1);
