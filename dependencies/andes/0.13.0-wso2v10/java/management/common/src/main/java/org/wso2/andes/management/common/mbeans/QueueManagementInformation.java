...
public interface QueueManagementInformation {
    ...
    @MBeanAttribute(name="QueueMessageCount",description = "Message count of the destination queue")
    int getMessageCountOfDestinationQueue(String queueName);

    @MBeanAttribute(name="MessageCountViewOption",description = "Configuration value of message count view option in the server")
    boolean getValueOfMsgCountViewOption();
}
