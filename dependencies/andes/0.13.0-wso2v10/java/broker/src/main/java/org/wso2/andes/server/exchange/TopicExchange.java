...
import org.wso2.andes.server.exchange.topic.*;
...
public class TopicExchange extends AbstractExchange
{
    ...
    public ArrayList<BaseQueue> doRoute(InboundMessage payload)
    {
        ...
        ClusterResourceHolder.getInstance().getCassandraMessageStore().addMessagePropertyToCassandra(
                AndesConstants.MESSAGE_EXPIRATION_PROPERTY, payload.getMessageNumber(), Long.toString(payload.getMessageHeader().getExpiration()));
