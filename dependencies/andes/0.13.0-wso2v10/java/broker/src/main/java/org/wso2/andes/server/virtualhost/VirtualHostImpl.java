...
public class VirtualHostImpl implements VirtualHost
{
    ...
    private VirtualHostImpl(IApplicationRegistry appRegistry, VirtualHostConfiguration hostConfig, MessageStore store) throws Exception
    {
        ...
        //Starting expired message removing task
        //TODO: Expired messages will be removed only when messages are tried to be sent to subscriber. Removed to reduce overhead on message store
        //ExpiredCassandraMessageRemover.getInstance();
