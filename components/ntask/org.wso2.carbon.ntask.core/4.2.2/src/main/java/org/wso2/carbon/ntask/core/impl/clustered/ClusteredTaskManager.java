...
public class ClusteredTaskManager extends AbstractQuartzTaskManager {
    ...
    public ClusterGroupCommunicator getClusterComm(String taskType) throws TaskException {
        return ClusterGroupCommunicator.getInstance(taskType);
    }
    ...
    public <V> V sendReceive(String memberId, TaskCall<V> taskCall)
        ...
        return this.getClusterComm(this.getTaskType()).sendReceive(memberId, taskCall);
    }

    public List<String> getMemberIds() throws TaskException {
        return this.getClusterComm(this.getTaskType()).getMemberIds();
    }

    public String getMemberId() throws TaskException {
        return this.getClusterComm(this.getTaskType()).getMemberId();
    }

    public boolean isLeader() throws TaskException {
        return this.getClusterComm(this.getTaskType()).isLeader();
    }
