...
//                    messageContext.setProperty(MessageContext.TRANSPORT_HEADERS, headers);
                    ...
                    try {
                        responseMessageContext = MessageContext.getCurrentMessageContext().getOperationContext().
                                getMessageContext(WSDLConstants.MESSAGE_LABEL_OUT_VALUE);
                    } catch (AxisFault axisFault) {
                        throw new AxisFault("Error in retrieving responseMessageContext : " + axisFault.getMessage(), axisFault);
                    }
