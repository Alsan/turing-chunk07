    ...
    public void deployArtifacts(CarbonApplication carbonApp, AxisConfiguration axisConfig)
        ...
        for (Artifact.Dependency dep : artifacts) {
            ...
            if (deployer != null) {
                ...
                //handling main and fault sequence deployment
                ...
                if (fileName.matches("main-\\d+\\.\\d+\\.\\d+\\.xml") || fileName.matches("main.xml")) {
                    try {
                        String mainXMLPath = axisConfig.getRepository().getPath() + "synapse-configs" +
                                File.separator + "default" + File.separator + "sequences" + File.separator + "main.xml";
                ...
                } else if (fileName.matches("fault-\\d+\\.\\d+\\.\\d+\\.xml") || fileName.matches("fault.xml")) {
                    try {
                        String faultXMLPath = axisConfig.getRepository().getPath() + "synapse-configs" +
                                File.separator + "default" + File.separator + "sequences" + File.separator + "fault.xml";
            ...
            if (deployer != null && AppDeployerConstants.DEPLOYMENT_STATUS_DEPLOYED.
                ...
                try {
                    ...
                    if (!fileName.matches("main-\\d+\\.\\d+\\.\\d+\\.xml") &&
                            !fileName.matches("main.xml") &&
                            !fileName.matches("fault-\\d+\\.\\d+\\.\\d+\\.xml") &&
                            !fileName.matches("fault.xml")) {
...
//					}
                    ...
                    //synapseArtifactDeployer.undeploy(artifactPath);
