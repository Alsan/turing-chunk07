        ...
        <form action="configure_message_tracing.jsp" method="post">
            ...
            <table width="100%" class="styledLeft" style="margin-left: 0px;">
                ...
                <tr>
                    <td colspan="4">
                        <% if (isMessageTracingEnable) { %>
                                <input type="checkbox" name="enableTracing" class="activityConfigurationCheckBox" onchange="enableActivityStreamFields()" checked="true" >&nbsp;&nbsp;&nbsp;&nbsp;
                        <% } else { %>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="activityConfigurationInput" id="url" name="url" value="<%=url%>"/>
                        <input type="button" class="activityConfigurationInput" value="Test Server" onclick="testServer()"/>
                    </td>
                </tr>

                <tr>
                    <td><fmt:message key="username"/></td>
                    <td><input type="text" class="activityConfigurationInput" name="user_name" value="<%=userName%>"/></td>
                </tr>
                <tr>
                    <td><fmt:message key="password"/></td>
                    <td><input type="password" class="activityConfigurationInput" name="password" value="<%=password%>"/></td>
                </tr>
                <tr>
