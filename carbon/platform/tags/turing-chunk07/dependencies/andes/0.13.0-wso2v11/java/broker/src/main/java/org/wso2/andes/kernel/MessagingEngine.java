...
public class MessagingEngine {
    ...
    private CassandraBasedMessageStoreImpl cassandraBasedMessageStore;
    ...
    private MessagingEngine() {
        cassandraBasedMessageStore = new CassandraBasedMessageStoreImpl();
    ...
    public CassandraBasedMessageStoreImpl getCassandraBasedMessageStore() {
	...
	public void setCassandraBasedMessageStore(
			CassandraBasedMessageStoreImpl cassandraBasedMessageStore) {
    ...
    private AndesMessageMetadata cloneAndesMessageMetadataAndContent(AndesMessageMetadata message) throws AndesException {
        ...
        cassandraBasedMessageStore.duplicateMessageContent(message.getMessageID(),newMessageId);
