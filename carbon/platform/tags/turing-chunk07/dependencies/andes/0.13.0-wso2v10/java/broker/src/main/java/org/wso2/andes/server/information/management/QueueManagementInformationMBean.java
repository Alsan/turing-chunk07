...
public class QueueManagementInformationMBean extends AMQManagedObject implements QueueManagementInformation {
    ...
    public QueueManagementInformationMBean() throws NotCompliantMBeanException {
        ...
        this.clusterConfiguration = ClusterResourceHolder.getInstance().getClusterConfiguration();
    ...
    public int getMessageCountOfDestinationQueue(String queueName){
        return (int) messageStore.getMessageCountForDestinationQueue(queueName);

    }

    public boolean getValueOfMsgCountViewOption() {
        return clusterConfiguration.getViewMessageCounts();
