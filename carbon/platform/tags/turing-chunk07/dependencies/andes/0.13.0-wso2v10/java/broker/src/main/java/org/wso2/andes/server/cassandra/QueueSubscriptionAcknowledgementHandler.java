...
public class QueueSubscriptionAcknowledgementHandler {
     ...
     * @throws AMQException
     */
    public boolean checkAndRegisterSent(QueueEntry queueEntry, long deliveryTag, AMQChannel channel) throws AMQException {
        return messageTracker.testAndAddMessage(queueEntry, deliveryTag, channel);
    }
