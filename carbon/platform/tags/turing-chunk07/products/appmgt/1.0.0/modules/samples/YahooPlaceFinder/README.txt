...
1. Extract wso2appmanager-xxx.zip (eg: wso2appmanager-1.0.0.zip)

2. Go to wso2appmanager-1.0.0/bin folder & type 'ant'

3. Start WSO2AM by executing wso2appmanager-1.0.0/bin/wso2server.sh
...
5. Run 'ant' inside wso2appmanager-1.0.0/samples/Data
...
populate-user-database:
      [sql] Executing resource: .....  /wso2appmanager-1.0.0/samples/Data/UserPopulator.sql
...
7. Run wso2appmanager-1.0.0/samples/YahooPlaceFinder/APIPopulator.sh (or APIPopulator.bat if you are on Windows)
