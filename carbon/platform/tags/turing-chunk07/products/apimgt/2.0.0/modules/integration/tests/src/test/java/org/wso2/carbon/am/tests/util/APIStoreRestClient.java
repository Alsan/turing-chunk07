...
public class APIStoreRestClient {
    ...
    public HttpResponse subscribe(AddAPISubscriptionRequest subscriptionRequest)
            throws Exception {
        checkAuthentication();
    ...
    public HttpResponse getAllPublishedAPIs()
            throws Exception {
        checkAuthentication();
        HttpResponse response = HttpRequestUtil.doGet("http://localhost:9763/store/site/blocks/api/listing/ajax/list.jag?action=getAllPublishedAPIs"
                , requestHeaders);
        if (response.getResponseCode() == 200) {
            return response;
        } else {
    ...
    public HttpResponse getAllApplications()
            throws Exception {
        checkAuthentication();
        HttpResponse response = HttpRequestUtil.doGet("http://localhost:9763/store/site/blocks/application/application-list/ajax/application-list.jag?action=getApplications"
                , requestHeaders);
        if (response.getResponseCode() == 200) {
            return response;
        } else {
    ...
    public HttpResponse getPublishedAPIsByApplication(String applicationName)
            throws Exception {
        checkAuthentication();
        HttpResponse response = HttpRequestUtil.doGet("http://localhost:9763/store/site/blocks/subscription/subscription-list/ajax/subscription-list.jag?action=getSubscriptionByApplication&app="+applicationName
                , requestHeaders);
        if (response.getResponseCode() == 200) {
            return response;
        } else {
    ...
    public HttpResponse addRatingToAPI(String apiName, String version, String provider, String rating)
            throws Exception {
        checkAuthentication();
        HttpResponse response = HttpRequestUtil.doGet("http://localhost:9763/store/site/blocks/api/api-info/ajax/api-info.jag?" +
    ...
    public HttpResponse getAllDocumentationOfApi(String apiName, String version, String provider)
            throws Exception {
        checkAuthentication();
        HttpResponse response = HttpRequestUtil.doGet("http://localhost:9763/store/site/blocks/api/listing/ajax/list.jag?" +
