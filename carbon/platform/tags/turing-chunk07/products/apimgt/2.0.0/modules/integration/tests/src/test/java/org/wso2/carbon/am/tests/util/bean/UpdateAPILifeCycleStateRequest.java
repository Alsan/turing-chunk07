 ...
 */
public class UpdateAPILifeCycleStateRequest extends AbstractRequest {
    private String name;
    ...
    public UpdateAPILifeCycleStateRequest(String apiName, String provider, APILifeCycleState status) {
        this.name = apiName;
