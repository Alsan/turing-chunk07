...
public class UserManagementClient {
    ...
    public void addRole(String roleName, String[] userList, String[] permissions) throws RemoteException, UserAdminUserAdminException{
...
//    }
    ...
    public void addInternalRole(String roleName, String[] userList, String[] permissions) throws RemoteException, UserAdminUserAdminException {    	
    	userAdminStub.addInternalRole(roleName, userList, permissions);
    }
    
    public FlaggedName[] getAllRolesNames(String filter, int limit) throws RemoteException, UserAdminUserAdminException {    	
    	return userAdminStub.getAllRolesNames(filter, limit);
    }
    
    public void addRemoveUsersOfRole(String roleName, String[] newUsers, String[] deletedUsers) throws RemoteException, UserAdminUserAdminException{    	
    	userAdminStub.addRemoveUsersOfRole(roleName, newUsers, deletedUsers);
    }
    
    public void addRemoveRolesOfUser(String userName, String[] newRoles, String[] deletedRoles) throws RemoteException, UserAdminUserAdminException{    	
    ...
    public void updateRolesOfUser(String userName, String[] newUserList) throws RemoteException, UserAdminUserAdminException{    	
    	userAdminStub.updateRolesOfUser(userName, newUserList);
    }
    
    public void changePassword(String userName, String newPassword) throws RemoteException, UserAdminUserAdminException{    	 
    	userAdminStub.changePassword(userName, newPassword);
    }
    
    public void updateRoleName(String roleName, String newRoleName) throws RemoteException, UserAdminUserAdminException{    	
    ...
    public void setRoleUIPermission(String roleName, String[] rawResources) throws RemoteException, UserAdminUserAdminException{
    ...
    public FlaggedName[] listUserByClaim(ClaimValue claimValue, String filter, int maxLimit) throws RemoteException, UserAdminUserAdminException{
