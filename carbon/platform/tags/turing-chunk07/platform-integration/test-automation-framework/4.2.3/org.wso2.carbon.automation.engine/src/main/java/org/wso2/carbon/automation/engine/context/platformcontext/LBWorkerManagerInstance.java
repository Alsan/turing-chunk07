...
/**
 * This class represents the Load Balance worker manager instance type
 */
public class LBWorkerManagerInstance extends Instance {
    private String workerHost = null;
    private String managerHost = null;

    /**
     * @param instance general instance node is fed and create specific type LBWorkerManger instance
     */
    public LBWorkerManagerInstance(Instance instance) {
