...
/**
 * this class is to represent Load Balance manager instances.
 */
public class LBManagerInstance extends Instance {
    private String managerHost = null;

    /**
     * @param instance general instance node is fed and create specific type LBManger instance
     */
    public LBManagerInstance(Instance instance) {
