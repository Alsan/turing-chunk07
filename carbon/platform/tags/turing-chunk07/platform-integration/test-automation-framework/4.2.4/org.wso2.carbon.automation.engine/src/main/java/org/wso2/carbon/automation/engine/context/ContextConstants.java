...
public class ContextConstants {
    ...
    public static final String CONFIGURATION_CONTEXT_MULTITENANT_MODE = "multiTenantMode";
    ...
    public static final String USER_MANAGEMENT_ADMIN_TENANT = "admin";
    ...
    public static final String PLATFORM_CONTEXT_INSTANCE_WORKER_HOST = "workerHost";
