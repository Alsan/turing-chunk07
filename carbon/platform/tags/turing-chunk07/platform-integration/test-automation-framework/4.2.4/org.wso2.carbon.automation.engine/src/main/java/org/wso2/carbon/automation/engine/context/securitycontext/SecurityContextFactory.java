...
public class SecurityContextFactory {
    private LinkedHashMap<String, KeyStore> keyStoreMap = new LinkedHashMap<String, KeyStore>();
    private LinkedHashMap<String, TrustStore> trustStoreMap = new LinkedHashMap<String, TrustStore>();
    ...
    public void createSecurityContext(OMElement nodeElement) {
        ...
        while (children.hasNext()) {
            ...
            if (storeName.equals(ContextConstants.SECURITY_STORES_KETSTORE)) {
                String keyStoreName = node.getAttribute
                        (QName.valueOf(ContextConstants.SECURITY_KEYSTORE_NAME))
                        .getAttributeValue();
                ...
                String trustStoreName = node.getAttribute
                        (QName.valueOf(ContextConstants.SECURITY_TRUSTSTORE_NAME))
                        .getAttributeValue();
        ...
        securityContext.setKeyStore(keyStoreMap);
        securityContext.setTrustStore(trustStoreMap);
    }
