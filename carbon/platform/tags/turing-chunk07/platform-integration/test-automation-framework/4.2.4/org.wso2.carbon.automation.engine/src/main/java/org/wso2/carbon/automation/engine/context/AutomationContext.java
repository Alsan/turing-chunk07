...
import org.wso2.carbon.automation.engine.context.databasecontext.DatabaseContext;
import org.wso2.carbon.automation.engine.context.environmentcontext.EnvironmentContext;
import org.wso2.carbon.automation.engine.context.extensions.ListenerExtensionContext;
import org.wso2.carbon.automation.engine.context.featuremgtcontext.FeatureManagementContext;
import org.wso2.carbon.automation.engine.context.platformcontext.PlatformContext;
import org.wso2.carbon.automation.engine.context.securitycontext.SecurityContext;
...
public class AutomationContext {
    ...
    private ListenerExtensionContext listenerExtensionContext;
    ...
    public void setListenerExtensionContext(ListenerExtensionContext listenerExtensionContext) {
        this.listenerExtensionContext = listenerExtensionContext;
    }
}
