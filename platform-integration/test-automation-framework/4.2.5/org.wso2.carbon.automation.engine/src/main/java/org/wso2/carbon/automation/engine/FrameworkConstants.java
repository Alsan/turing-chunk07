...
public class FrameworkConstants {
    ...
    public static final String SYSTEM_PROPERTY_RESOURCE_LOCATION =
    ...
    public static final String AXIS2_SIMPLE_STOCK_QUOTE_SERVICE = "SimpleStockQuoteService";
    public static final String AXIS2_SECURE_STOCK_QUOTE_SERVICE = "SecureStockQuoteService";
    public static final String AXIS2_LB_SERVICE_1 = "LBService1";
    public static final String AXIS2_LB_SERVICE_2 = "LBService2";
    public static final String AXIS2_LB_SERVICE_3 = "LBService3";
    public static final String AXIS2_SIMPLE_AXIS2_SERVICE = "Axis2Service";
    public static final String AXIS2_STUDENT_REST_SERVICE = "StudentService";
    public static final String AXIS2_CONFIG_FILE_NAME = "test_axis2_server_9000.xml";
    public static final int DEFAULT_CARBON_PORT_OFFSET = 0;
    public static final String DEFAULT_CARBON_DEBUG_PORT = "5005";
    ...
    public static final String SERVER_STARTUP_DEBUG_PORT = "-debug";
