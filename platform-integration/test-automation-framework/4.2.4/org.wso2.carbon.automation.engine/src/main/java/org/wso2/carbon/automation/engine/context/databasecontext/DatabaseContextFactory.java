    ...
    public void createDatabaseContext(OMElement nodeElement) {
        ...
        while (children.hasNext()) {
            ...
            while (configPropertiesIterator.hasNext()) {
                ...
                database.addProperty(attribute, attributeValue);
            }
            databaseMap.put(databaseName, database);
        }
        databaseContext.setDatabaseConfigurationMap(databaseMap);
    }

    /*
     * this method return the databaseContext object providing the appropriate
      * database node in Automation.xml
     */
