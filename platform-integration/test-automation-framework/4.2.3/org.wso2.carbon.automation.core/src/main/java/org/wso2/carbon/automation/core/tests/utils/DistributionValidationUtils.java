...
*under the License.
*/
package org.wso2.carbon.automation.core.tests.utils;
...
public class DistributionValidationUtils {
    ...
    public void readLicenseFile(String productPath, HashSet<String> licenceJarList,
    ...
    public void validateXml(HashMap<String, Exception> xsdValidateMap,
    ...
    public List<String> getLinks(String url) throws ParserException {
    ...
    public List<File> recursiveScanToRetrieveTextualFiles(String path, String[] extensionList) {

        File dir = new File(path);
        return (List<File>) FileUtils.listFiles(dir, extensionList, true);
    }

    public <T> Set getDuplicateJarSet(Collection<T> list) {
    ...
    public void identifyDuplicateJars(List<File> jarFileListInDistribution, File distributionVersion,
    ...
    public ArrayList<String> validateSamplesDirectoryStructureIdentifyVersions(String samplesDirPath,
    ...
    public void searchDirectoryByName(String baseDir, ArrayList<String> directoryLists, String dirName) {
    ...
    public void reportGeneratorList(List<String> list, String topic, File reportFile)
    ...
    public void reportGeneratorMap(HashMap map, String topic, File reportFile)
            throws FileNotFoundException, UnsupportedEncodingException {
